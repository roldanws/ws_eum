...
from .views import CorteApiView,consultaBoletoApiView,consultaBoletoEumApiView,notiBoletoPagadoApiView,registroBoletoApiView
...
urlpatterns = [
    ...
    path('notiBoletoPagado/', notiBoletoPagadoApiView.as_view(), name='notiBoletoPagado'), 
