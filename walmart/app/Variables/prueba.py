    ...
    def run (self):
        ...
        if isinstance (self.objeto, list):
            ...
            for i, elemento in enumerate(self.objeto):
                ...
                self.etiquetaValor[i].move(600,20*i)
        ...
        if isinstance (self.objeto, Variable):
            ...
            self.etiquetaValor.append(elemento.obtenerInterfazGrafica(1).obtenerEtiquetaValor(self.area))
            self.etiquetaValor[i].move(600,10)
        ...
        self.area.setGeometry(100, 100, 700, 400)
        self.area.show()
        app.exec_()
    ...
    def run (self):
        ...
        if isinstance (self.objeto, list):
            ...
            for i, elemento in enumerate(self.objeto):
                ...
                self.etiquetaValor_2[i].grid(row = i + 1, column = 3, sticky=W, pady=5, padx=5)   
        ...
        self.root.geometry ("600x400+700+100")
        self.root.mainloop()
