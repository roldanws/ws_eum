...
class ProtocoloCCTALK ():
    ...
    def enviarInstruccion_4 (self):
        a = self.puerto.comunicacion.crearInstruccion(Comunicacion.PROCESO, Comunicacion.CCTALK_DATOS, [3, 0, 1, 254, 254])
...
class ProtocoloCCTALKInterfaz ():
    ...
    def obtenerFrame (self, master):
        ...
        self.frameHex = self.obtenerFrameEnviarDatosHexadecimal(master)
