...
class IPRO ():
    ...
    def enviarDatos (self, datos):
        ...
        a = self.puerto.comunicacion.crearInstruccion(Comunicacion.PROCESO, Comunicacion.IPRO, mensaje)
        self.puerto.enviarBytes(a)
...
class ProtocoloIPROInterfaz ():
    ...
    def obtenerFrame (self, master):
        ...
        self.frame = LabelFrame (master, text ="IPRO")
